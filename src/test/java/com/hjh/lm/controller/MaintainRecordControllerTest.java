...
public class MaintainRecordControllerTest {
    ...
    @Test
    public void getFixRecordsByLiftId() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/maintainregist").param("liftId", "11")
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print())
                .andReturn();
